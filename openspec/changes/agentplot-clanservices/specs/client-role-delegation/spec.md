...
### Requirement: Delegation to programs.claude-code (Phase 1)
...
### Requirement: Delegation to programs.agent-skills (Phase 2)
...
### Requirement: Delegation to programs.agent-deck (Phase 2)
...
### Requirement: Delegation to programs.openclaw (Phase 2)
...
### Requirement: Delegation to programs.claude-tools (Phase 2)
...
### Requirement: Per-client CLI wrapper script (Phase 1)
